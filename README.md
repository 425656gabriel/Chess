...
- Simple and intuitive click-based controls  
- Restart game functionality  
- Optional difficulty selection (if implemented)  
...
2. The player selects a destination square  
3. The program checks if the move is valid  
4. If valid, the move is executed  
5. The turn switches to the other player  

This process ensures that all gameplay follows the rules of traditional chess.
...
![End Screen](https://github.com/425656gabriel/App-Ideas/blob/main/Chess/src/GUI%20Mockups/End%20Screen.png)
